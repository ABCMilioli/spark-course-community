  ...
  return (
    <div className="flex-1 p-4 sm:p-6 bg-muted/40">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-6 sm:mb-8">
          <Button variant="ghost" size="sm" onClick={() => navigate('/forum')} className="w-full sm:w-auto">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold">{topicData.topic.title}</h1>
                {topicData.topic.description && (
                  <p className="text-sm sm:text-base text-muted-foreground mt-1 sm:mt-2">{topicData.topic.description}</p>
                )}
              </div>
            </div>
          </div>
                  ...
                  {post.content_image_url && (
                    <div className="flex-shrink-0">
                      <img 
                        ...
                        alt="Imagem de apoio" 
                        className="w-full sm:w-32 h-24 object-cover rounded-lg border"
                      />
                    </div>
                  )}
